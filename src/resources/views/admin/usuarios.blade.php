         ...
         <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
             ...
             <div class="bg-white border border-[#C5BBB0]/30 overflow-hidden mb-8">
                 <div class="bg-[#1A1612] px-6 py-4 flex justify-between items-center">
                    ...
                    <span class="text-[11px] text-[#8C8070] uppercase tracking-widest">{{ $totalUsuarios ?? $usuarios->total() ?? 0 }} en total</span>
                 </div>
                 <div class="overflow-x-auto">
                     <table class="w-full border-collapse">
                         ...
                         <tbody>
                             ...
                             <tr class="border-b border-[#C5BBB0]/10 hover:bg-[#C9A84C]/[0.03] transition-colors">
                                 ...
                                 <td class="px-5 py-3">
                                     <div class="flex gap-2">
                                        ...
                                        <button onclick="confirmarEliminar({{ $usuario->id }}, @js($usuario->name))"
                             ...
                             @empty
                            <tr>
                                <td colspan="5" class="px-5 py-8 text-center text-[13px] text-[#8C8070]">
                                    No hay usuarios registrados en la base de datos todavía.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
             ...
             <div class="p-6">
                 <form method="POST" action="{{ route('admin.usuarios.store') }}">
                    ...
                    <div class="flex flex-col gap-1.5 mb-4">
                        <label class="text-[10px] uppercase tracking-[0.15em] text-[#8C8070]">Nombre completo</label>
                        <input type="text" name="name" placeholder="Ana García López" required
                     ...
                     <div class="flex flex-col gap-1.5 mb-4">
                        ...
                        <input type="email" name="email" placeholder="ana@correo.com" required
                             class="border border-[#C5BBB0]/40 bg-[#FAF8F4] px-3 py-2 text-sm text-[#1A1612] focus:outline-none focus:border-[#C9A84C] rounded-none">
                     </div>
